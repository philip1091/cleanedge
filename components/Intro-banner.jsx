...
const IntroBanner = () => {
	return (
		<div className="services-strip bg-green flex flex-wrap justify-around overflow-hidden">
			...
			<div className="w-1/2 md:w-1/4 strip-item border-r border-black/10 border-b md:border-b-0 flex items-center gap-4 p-6 relative transition-colors duration-500 hover:bg-green-dark ">
			...
			<div className="w-1/2 md:w-1/4 strip-item border-r border-black/10 border-b md:border-b-0 flex items-center gap-4 p-6 relative transition-colors duration-200 hover:bg-green-dark ">
